...
Proof.
  ...
  - intros m. destruct m as [| m'] eqn:E.
    + simpl. intros H. discriminate H.
    + simpl. intros H. f_equal. apply IHn'. apply H.
Qed.
(** [] *)
...
Proof.
  ...
  - destruct b eqn:E2.
    + rewrite -> E1. rewrite -> E1. apply E1.
...
Proof.
  ...
  - intros l2 H.
    destruct l2 as [| l2'] eqn:E.
    + simpl. reflexivity.
    + discriminate H.
  - intros l2 H.
    destruct l2 as [|m l2'] eqn:E.
    + discriminate H.
    + assert (length l1' = length l2') as H'.
      { injection H as H1. apply H1. }
      apply IHl1' in H'.
      simpl.
      destruct (split (combine l1' l2')) as [lx ly].
      ++ injection H' as H1 H2.
         f_equal. f_equal. apply H1.
         f_equal. f_equal. apply H2.
Qed.
