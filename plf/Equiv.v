...
Proof.
  ...
  - intros H.
    inversion H.
    + apply E_IfFalse.
      * simpl in H5. apply negb_true_iff. assumption.
      * assumption.
    + apply E_IfTrue.
      * simpl in H5. apply negb_false_iff. assumption.
      * assumption.
Qed.
(** [] *)
...
Proof.
  ...
  - intros H.
    inversion H; subst.
    + apply E_IfTrue.
      * rewrite <- (H1 st). assumption.
      * apply (H2 st st'). assumption.
    + apply E_IfFalse.
      * rewrite <- (H1 st). assumption.
      * apply (H3 st st'). assumption.
  - intros H.
    inversion H; subst.
    + apply E_IfTrue.
      * rewrite (H1 st). assumption.
