...
Lemma rev_app: forall (l: natlist) (x: nat),
  rev (l ++ [x]) = [x] ++ rev l.
Proof.
  intros l x.
  induction l as [| n l' IHl'].
...
*)
Theorem bag_count_sum : forall (s1 : bag) (s2 : bag) (n : nat),
